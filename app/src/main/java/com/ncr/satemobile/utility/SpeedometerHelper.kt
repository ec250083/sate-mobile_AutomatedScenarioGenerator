...
object SpeedometerHelper {
     ...
     * @param maxValue                  Max speedometer value
     */
   /* fun moveSpeedometer(speedometerLayer: LayerDrawable, imageView: ImageView, desiredValue: Float, maxValue: Float) {
        moveSpeedometer(speedometerLayer, imageView, desiredValue, maxValue)
    }*/
}